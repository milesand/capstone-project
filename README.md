...
| /download |파일 다운로드|-|-|-|
| /mkdir |디렉토리 생성|-|-|-|
| /directory/(?P<pk>[0-9a-z-]{36})|-|특정 디렉터리 하위 폴더 및 파일 정보 출력|디렉토리 삭제|디렉토리명 변경|
| /thumbnail/<str : id>|썸네일 생성|-|-|-|
| /partial/(?P<pk>[0-9a-z-]{36})|-|-|특정 partial upload file 제거. 업로드를 중단할 때 사용|-|

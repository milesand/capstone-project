...
class File(models.Model):
    ...
    user=models.ForeignKey(to=settings.AUTH_USER_MODEL, db_index=False, unique=False, on_delete=models.CASCADE, related_name='file', ) # File 모델을 특정 사용자와 many-to-one 관계로 연결
